...
public class HeadBob : MonoBehaviour
{
    ...
    public float bobStrengthFactor;
    ...
    private void HandleHeadBobbing()
    {
        ...
        if (!useHeadBob)
        {
            if (headTransform.localPosition != headStartPoint)
                headTransform.localPosition = Vector3.Lerp(headTransform.localPosition, headStartPoint, Time.deltaTime * 2);

            if (headTransform.localRotation != headStartRotation)
                headTransform.localRotation = Quaternion.Lerp(headTransform.localRotation, headStartRotation, Time.deltaTime * 2);
        ...
        if (isMoving)
        {
            ...
            bobStrengthFactor = Mathf.Clamp01(5 / 2.5f);
