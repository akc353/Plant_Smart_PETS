              ...
              if ((Time.time - timeEnteredCanvas[whichPointer] >= Time.deltaTime)) {
                ...
                if (currentOverGo[whichPointer] != null) {
                  ...
                  if (PointEvents[whichPointer].pointerDrag) {
                    ...
                    if (Dragger != null) {
                      if (Dragger is LeapEventTrigger && PointEvents[whichPointer].pointerDrag.transform.parent) { //Hack: EventSystems intercepting Drag Events causing funkiness
                        ...
                        if (PointEvents[whichPointer].pointerDrag != null) {
                          ...
                          if ((Dragger != null) && !(Dragger is LeapEventTrigger)) {
